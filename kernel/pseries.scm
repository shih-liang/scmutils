...
(assign-operation 'solve-linear-left   (lambda (x y) (series/coefficient y x))   series?        not-series?)
(assign-operation 'solve-linear-left   (lambda (x y) (coefficient/series y x))   not-series?    series?)

(assign-operation 'solve-linear   (lambda (x y) (series:div y x))           series?        series?)
(assign-operation 'solve-linear   (lambda (x y) (series/coefficient y x))   series?        not-series?)
(assign-operation 'solve-linear   (lambda (x y) (coefficient/series y x))   not-series?    series?)
